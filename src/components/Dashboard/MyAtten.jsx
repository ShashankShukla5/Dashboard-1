  ...
  return (
    <div className="w-full sm:w-full lg:w-[30%] bg-white rounded-2xl border">
      <div className="flex flex-col gap-3 px-5">
        <div className="flex flex-col xs:flex-row gap-2 xs:gap-base justify-between items-start xs:items-center border-b py-7 mb-5">
          <p>My Attendance</p>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-base justify-between">
          <div className="flex flex-col items-start gap-3">
            <div className="flex items-center gap-3">
              <div className="min-h-2.5 min-w-2.5 h-2.5 w-2.5 rounded-full bg-green-600"></div>
              <p>
                {globalData.onTime}{" "}
            ...
            <div className="flex items-center gap-3">
              <div className="min-h-2.5 min-w-2.5 h-2.5 w-2.5 rounded-full bg-yellow-600"></div>
              <p>
            ...
            <div className="flex items-center gap-3">
              <div className="min-h-2.5 min-w-2.5 h-2.5 w-2.5 rounded-full bg-red-600"></div>
              <p>
            ...
            <div className="flex items-center gap-3">
              <div className="min-h-2.5 min-w-2.5 h-2.5 w-2.5 rounded-full bg-gray-600"></div>
              <p>
                {globalData.absent}{" "}
